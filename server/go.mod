...
require (
	...
	github.com/toniz/SLS-Aliyun v0.0.0-20210910110203-a67c72077ca5
	github.com/toniz/gosuit v0.1.57 // indirect
	github.com/toniz/otel v1.0.0 // indirect
	github.com/toniz/trace v1.0.1
